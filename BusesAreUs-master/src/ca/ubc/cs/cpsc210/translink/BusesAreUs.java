...
public class BusesAreUs extends Activity implements LocationListener, StopSelectionListener {
    ...
    public static final String TRANSLINK_API_KEY = TranslinkToken.TRANSLINK_API_KEY;
    ...
    public void onLocationChanged(Stop nearest, LatLon locn) {
        ...
        if (this.myNearestStop == null) {
            this.nearestStopLabel.setText(R.string.out_of_range);
        } else {
            this.nearestStopLabel.setText(this.myNearestStop.getNumber() + " " + this.myNearestStop.getName());
        }
